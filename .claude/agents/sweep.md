...
1. **Less is more** - A lean codebase is a maintainable codebase
2. **Evidence over assumption** - Prove it's unused before removing
...
| Scenario | Agent |
|----------|-------|
| "Remove unused files" | **Sweep** |
| "Find and delete dead code" | **Sweep** |
